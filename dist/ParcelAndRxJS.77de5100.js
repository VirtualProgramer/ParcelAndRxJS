...
rxjs_1.fromEvent(document, 'click').pipe().subscribe(function (position) {
  // console.log(`x: ${position.x}, y: ${position.y}`);
  console.log("x: " + position.x + ", y: " + position.y);
}); // 发出 (1,2,3,4,5)

var source = rxjs_1.from([1, 2, 3, 4, 5]); // 过滤掉奇数
...
},{}]},{},["C:/Users/Jin-Wen/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.ts"], null)
//# sourceMappingURL=/ParcelAndRxJS.77de5100.js.map