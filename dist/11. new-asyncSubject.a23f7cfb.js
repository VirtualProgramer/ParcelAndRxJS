...
var source$ = new rxjs_1.AsyncSubject();
source$.subscribe(function (data) {
  return console.log("AsyncSubject \u7B2C\u4E00\u6B21\u8A02\u95B1: " + data);
});
source$.next(1);
source$.next(2);
source$.subscribe(function (data) {
  return console.log("AsyncSubject \u7B2C\u4E8C\u6B21\u8A02\u95B1: " + data);
});
source$.next(3);
source$.next(4);
source$.subscribe(function (data) {
  return console.log("AsyncSubject \u7B2C\u4E09\u6B21\u8A02\u95B1: " + data);
});
source$.complete();
...
},{}]},{},["C:/Users/Jin-Wen/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","components/11. new-asyncSubject.ts"], null)
//# sourceMappingURL=/11.%20new-asyncSubject.a23f7cfb.js.map