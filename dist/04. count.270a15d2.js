...
var evenCountTxt = document.getElementById('evenCountTxt');
var count = 0;
var counter$;
rxjs_1.fromEvent(startBtn, 'click').subscribe(function (x) {
  count = 0;
  counter$ = new rxjs_1.Subject();
  var evenCounter$ = counter$.pipe(operators_1.filter(function (x) {
    return x % 2 === 0;
  }));
  counter$.subscribe({
  ...
  evenCounter$.subscribe(function (x) {
    evenCountTxt.innerText = x.toString();
  });
  counter$.next(count);
});
rxjs_1.fromEvent(finishBtn, 'click').subscribe(function (x) {
  counter$.complete();
});
rxjs_1.fromEvent(countBtn, 'click').subscribe(function (x) {
  counter$.next(++count);
});
rxjs_1.fromEvent(errorBtn, 'click').subscribe(function () {
  var reason = prompt('請輸入錯誤訊息');
  counter$.error(reason || 'error');
});
},{"rxjs":"node_modules/rxjs/_esm5/index.js","rxjs/operators":"node_modules/rxjs/_esm5/operators/index.js"}],"C:/Users/Jin-Wen/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/Jin-Wen/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","components/04. count.ts"], null)
//# sourceMappingURL=/04.%20count.270a15d2.js.map