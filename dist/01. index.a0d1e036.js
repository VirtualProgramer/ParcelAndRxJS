...
var operators_1 = require("rxjs/operators"); // 發出 (1,2,3,4,5)


rxjs_1.from([1, 2, 3, 4, 5]).pipe( // 過濾奇數
operators_1.filter(function (num) {
  return num % 2 === 0;
})).subscribe( // 输出: "Even number: 2", "Even number: 4"
function (val) {
  return console.log("Even number: " + val);
}); // 發出 (1,2,3,4,5)

var source = rxjs_1.from([1, 2, 3, 4, 5]); // 過濾奇數

var example = source.pipe(operators_1.filter(function (num) {
  return num % 2 === 0;
...
},{}]},{},["C:/Users/Jin-Wen/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","components/01. index.ts"], null)
//# sourceMappingURL=/01.%20index.a0d1e036.js.map