...
var subscriber = function subscriber(_subscriber) {
...
observable$.subscribe({
  next: function next(data) {
    return console.log("Observable \u7B2C\u4E00\u6B21\u8A02\u95B1: " + data);
  },
  complete: function complete() {
    return console.log('第一次訂閱完成');
  }
});
observable$.subscribe({
  next: function next(data) {
    return console.log("Observable \u7B2C\u4E8C\u6B21\u8A02\u95B1: " + data);
  },
  complete: function complete() {
    return console.log('第二次訂閱完成');
  }
});
observable$ = new rxjs_1.Observable(function (subscriber) {
  console.log('stream 開始');
  subscriber.next(1);
  subscriber.next(2);
  subscriber.next(3);
...
observable$.subscribe({
  next: function next(data) {
    return console.log("Observable \u7B2C\u4E09\u6B21\u8A02\u95B1: " + data);
  },
  complete: function complete() {
    return console.log('第三次訂閱完成');
  }
});
console.log("------非同步-------");
...
},{}]},{},["C:/Users/Jin-Wen/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","components/07. new-observable.ts"], null)
//# sourceMappingURL=/07.%20new-observable.28179381.js.map