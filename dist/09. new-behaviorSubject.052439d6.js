...
var source$ = new rxjs_1.BehaviorSubject(0);
source$.subscribe(function (data) {
  return console.log("BehaviorSubject \u7B2C\u4E00\u6B21\u8A02\u95B1: " + data);
}); // BehaviorSubject 第一次訂閱: 0

source$.next(1);
source$.next(2);
source$.subscribe(function (data) {
  return console.log("BehaviorSubject \u7B2C\u4E8C\u6B21\u8A02\u95B1: " + data);
});
source$.next(3);
source$.next(4);
...
},{}]},{},["C:/Users/Jin-Wen/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","components/09. new-behaviorSubject.ts"], null)
//# sourceMappingURL=/09.%20new-behaviorSubject.052439d6.js.map